...
const SkeletonCard = () => (
  <div className="w-full px-4 md:w-1/2 lg:w-1/3">
    <div className="mx-auto mb-10 max-w-[370px] animate-pulse overflow-hidden rounded-md">
      <div className="aspect-[77/40] bg-gray-200 dark:bg-gray-700" />
      <div className="bg-white p-4 dark:bg-dark">
      ...
      <div className="container">
        ...
        <div className="-mx-4 flex flex-wrap">
          {loading
            ...
            : videos.map((video) => (
                <div key={video.videoId} className="w-full px-4 md:w-1/2 lg:w-1/3">
