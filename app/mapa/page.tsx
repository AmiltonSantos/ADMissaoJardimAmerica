...
const MapaPage = () => {
  ...
  const filialLocations = [
    ...
    { id: 3, nome: 'Assembléia De Deus Ministério Missão Faiçalville', lat: -16.744697311090025, lng: -49.31881795557049, icon: '/images/location/point.png', foto: '/images/location/sede.jpg' },
    ...
    { id: 11, nome: 'Assembleia de Deus missão - Veiga Jardim', lat: -16.78524699420472, lng: -49.27453895787004, icon: '/images/location/point.png', foto: '/images/location/sede.jpg' },
    { id: 12, nome: 'Assembleia de Deus Missão - Jardim Itaipú', lat: -16.78836500523481, lng: -49.36499778401419, icon: '/images/location/point.png', foto: '/images/location/sede.jpg' },
    { id: 13, nome: 'Igreja AD Missão - Cardoso II', lat: -16.76494569342303, lng: -49.32432391320159, icon: '/images/location/point.png', foto: '/images/location/sede.jpg' },
    { id: 14, nome: 'Assembleia de Deus Missão - Flor do Ipê', lat: -16.656835775689512, lng: -49.13562405238455, icon: '/images/location/point.png', foto: '/images/location/sede.jpg' },
    { id: 15, nome: 'Ad Missão Pedro Miranda', lat: -16.729951881485526, lng: -49.089200042588494, icon: '/images/location/point.png', foto: '/images/location/sede.jpg' },
    { id: 15, nome: 'Ad Missão Alice Barbosa', lat: -16.594915641070433, lng: -49.27100487364266, icon: '/images/location/point.png', foto: '/images/location/sede.jpg' },
  ];
