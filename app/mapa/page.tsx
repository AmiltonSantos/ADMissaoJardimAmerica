...
const MapaPage = () => {
  ...
  const filialLocations = [
    ...
    { id: 9,  nome: 'AD Missão Jardim América - João Brás',               lat: -16.688402737957688, lng: -49.35104938908731, icon: '/images/location/point.png' },
    ...
    { id: 14, nome: 'AD Missão Jardim América - Flor do Ypê',             lat: -16.656835775689512, lng: -49.13562405238455, icon: '/images/location/point.png' },
    ...
    { id: 17, nome: 'AD Missão Jardim América - Itanhangá',               lat: -16.570161623870188, lng: -49.2790875757447,  icon: '/images/location/point.png' },
    ...
    { id: 22, nome: 'AD Missão Jardim América - São Bernardo',            lat: -16.577537606136108, lng: -49.399599419983076, icon: '/images/location/point.png' },
    { id: 23, nome: 'AD Missão Jardim América - Anicuns/GO',              lat: -16.45965196811984,  lng: -49.95524654657013, icon: '/images/location/point.png' },
    { id: 24, nome: 'AD Missão Jardim América - Rio Araguaia',            lat: -16.657842127287832, lng: -49.16011057973828, icon: '/images/location/point.png' },
  ];
          ...
          <div key={filial.id}>
            ...
            {hoveredFilial === filial.id && (
              ...
              >
                ...
                >
                  <Image
                    src={`/api/streetview?lat=${filial.lat}&lng=${filial.lng}`}
                    unoptimized
                    alt={filial.nome}
                    width={200}
                    height={120}
